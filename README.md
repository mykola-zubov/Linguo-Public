...
*   **Жива демо-версія застосунку**: [https://zubov.pythonanywhere.com](https://zubov.pythonanywhere.com)
*   **Цифровий сертифікат бази даних (Dataset DOI)**: [Вставте сюди DOI вашої бази даних із Zenodo]
*   **Цифровий сертифікат коду (Software DOI)**: [Вставте сюди DOI вашої програми із Zenodo]
